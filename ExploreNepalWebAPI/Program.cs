...
{
    opt.AppId = "3661895764081324";
    opt.AppSecret = "da1849b60887b1431353039271c3db50";
});
...
app.UseCors(x => x
    ...
    .AllowCredentials() // Allows credentials to be included in cross-origin requests
    .WithOrigins("http://localhost:5173") // Allow requests from this origin
    .WithOrigins("https://localhost:7090") // Allow requests from this origin
